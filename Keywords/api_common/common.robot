...
[common][verify] - description is "${description}"
    REST.string    $.body.status.description    ${description}

[common][verify] - data is "${data}"
    REST.string    $.data[0]    ${data}
...
[common][extract] - status code
    ${id}    rest extract    $.status.code
    [common] - Set variable    name=code    value=${id}
